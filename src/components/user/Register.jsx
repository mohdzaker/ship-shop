    ...
    <>
      ...
      <main className="w-full min-h-screen bg-gray-100 flex justify-center items-center py-8">
        <div id="form" className="bg-white rounded-lg border border-green-600 shadow-lg p-12 max-w-md w-full">
          <h2 className="text-3xl font-bold mb-6 text-bg-primary">Register</h2>
          ...
          <p className="text-lg text-gray-600 mt-6 mb-4 flex items-center justify-center">
            Already have an account? <a href="/login" className="text-green-600 font-semibold hover:underline ml-2">Log in</a>
          </p>
