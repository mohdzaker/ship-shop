    ...
    <>
      ...
      <main className="w-full min-h-screen bg-gray-100 flex justify-center items-center py-8 px-4 sm:px-6 lg:px-8">
        <div id="form" className="bg-white rounded-lg border border-green-600 shadow-lg p-6 sm:p-8 lg:p-12 max-w-md w-full">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-bg-primary">Register</h2>
          <form onSubmit={handleSubmit}>
            <div className="mb-4 sm:mb-6">
              ...
              <input
                ...
                className={`border rounded-lg py-2 px-3 sm:py-3 sm:px-4 w-full text-base sm:text-lg outline-none transition duration-300 ${
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <input
                ...
                onChange={handleChange}
                className={`border rounded-lg py-2 px-3 sm:py-3 sm:px-4 w-full text-base sm:text-lg outline-none transition duration-300 ${
                  errors.confirmPassword ? 'border-red-600 focus:ring-red-300' : 'border-green-600 focus:ring-green-300'
                }`}
          ...
          Already have an account? <Link href="/login" className="text-green-600 font-semibold hover:underline ml-1 sm:ml-2">Login</Link>
          </p>
